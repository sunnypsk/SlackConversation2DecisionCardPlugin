...
class AIDC_Plugin {
	...
	public function on_activate() {
		...
		// Phase 1: Use new CPT class for consistency
	...
	// Phase 1: register_cpt() method moved to AIDC\Includes\Cpt class
	...
	// Phase 1: register_meta_fields() method moved to AIDC\Includes\Cpt class
